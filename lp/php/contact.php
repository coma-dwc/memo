...
<html lnag="ja">
  ...
  <body>
    <!--<header id="header">-->
    <!--  <h1 class="site-title"><a href="lp.html"><img src="img/logo.svg" alt="My Work"></a></h1>-->
    <!--  <nav>-->
    <!--    <ul>-->
    ...
    <main>
      ...
      <!--  </ul>-->
      <!--  <p>-->
      <!--    プロフィールテキストテキストテキストテキストテキストテキストテキストテキストテキストテキス-->
      ...
      <!--  <dl>-->
      <!--    <dt>2020.XX.XX</dt>-->
      <!--    <dd>デザイン雑誌「ＸＸＸＸＸ Vol.11」に掲載していただきました。</dd>-->
      <!--    <dt>2020.XX.XX</dt>-->
      <!--    <dd>ＸＸ月ＸＸ日から写真集「ＸＸＸＸＸＸ」の販売を開始します。</dd>-->
      <!--    <dt>2019.XX.XX</dt>-->
      <!--    <dd>【イベント開催のお知らせ】テキストテキストテキストテキストテキストテキスト</dd>-->
      <!--    <dt>2019.XX.XX</dt>-->
      <!--    <dd>デザイン雑誌「ＸＸＸＸＸ Vol.10」に掲載していただきました。</dd>-->
      <!--    <dt>2019.XX.XX</dt>-->
      <!--    <dd>【個展開催のお知らせ】テキストテキストテキストテキストテキストテキスト</dd>-->
      <!--  </dl>-->
      <!--</section>-->

      <!-- ここでcontact.phpをインクルード -->
